...
import {SuperRPGMenu_Ingame} from "./SuperRPGMenu_Ingame";
import {SuperRPG} from "./SuperRPG";
import {CallbackCollection} from "./CallbackCollection";
import {RenderArea} from "./RenderArea";
import {Random} from "./Random";
import {SuperRPGMenuEntry} from "./SuperRPGMenuEntry";

export class SuperRPGMenu_Monster extends SuperRPGMenu_Ingame {
    // Damage and defense
    ...
    private setMonster(asciiName: string, damage: number, defense: number, coins: number, hp: number, maxHp: number | null = null): void {
