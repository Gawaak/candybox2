...
import {Pos} from "./Pos";
import {PlayerSummonedOctopusKing} from "./PlayerSummonedOctopusKing";

export class OctopusKingCrownWithObsidian extends EqItem{
    ...
    // Private methods
    private summonOctopusKing(_player: Player, quest: Quest): boolean{
        // Create the king
