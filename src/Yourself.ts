...
import {YourselfEntity} from "./YourselfEntity";
...
export class Yourself extends Quest{
    ...
    private addYourself(): void{
        ...
        this.yourself.setHealthBar(new QuestEntityHealthBar(this.yourself, new Pos(100, 1), new Pos(0, 1), QuestEntityHealthBarPositionType.FIXED_ON_PAGE, true, true, BarType.HEALTH));
