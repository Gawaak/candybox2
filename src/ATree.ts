...
import {ATreeTicTacToeSign} from "./ATreeTicTacToeSign";
import {ATreeTicTacToeStep} from "./ATreeTicTacToeStep";
import {Game} from "./Game";
import {Database} from "./Database";
import {EnigmaAnswer} from "./EnigmaAnswer";
import {ATreeTicTacToeMinimaxReturnValue} from "./ATreeTicTacToeMinimaxReturnValue";
import {Pos} from "./Pos";
...
export class ATree extends Place {
    ...
    private ticTacToeStep: ATreeTicTacToeStep | null = null;
    private ticTacToeBoard: ATreeTicTacToeSign[][] = [];
    ...
    private addEnigma(enigmaAnswer: EnigmaAnswer, callbackCollection: CallbackCollection, otherClass: string, wrongClass: string = "", wrongMessage: string = "Wrong"): void {
        ...
        this.renderArea.addLinkCall(`.${otherClass}`, callbackCollection)
        this.renderArea.addLinkCall(`.${wrongClass}`, new CallbackCollection(() => {
            this.update();
    ...
    private playTicTacToe_testGameSomeoneWon(): ATreeTicTacToeSign {
        // Variables
        var returnSign: ATreeTicTacToeSign | null;
    ...
    private playTicTacToe_fiveInARow(x1: number, y1: number, x2: number, y2: number): ATreeTicTacToeSign | null {
        // Variables
        var column: number = x1;
        var row: number = y1;
        var counter: number = 0;
        var currentSign: ATreeTicTacToeSign | null = null;
    ...
    private update(): void {
        ...
        switch (Saving.loadNumber("aTreeStep")) {
            ...
            case 1:
                ...
                this.addEnigma(new EnigmaAnswerStrings(["yes", "y", "yeah", "yeap", "yep"], ["no", "n", "I hate it", "not at all", "ew"]), new CallbackCollection(this.nextStep.bind(this), this.reward1.bind(this)), "aTreeFirstQuestionEnigma", "aTreeFirstQuestionWrong");
                break;
            ...
            case 2:
                ...
                this.addEnigma(new EnigmaAnswerStrings(["c"], ["a", "v", "s", "j", "b", "y"]), new CallbackCollection(this.nextStep.bind(this), this.reward2.bind(this)), "aTreeSecondQuestionEnigma", "aTreeSecondQuestionWrong");
                break;
            ...
            case 3:
                ...
                this.addEnigma(new EnigmaAnswerStrings([`A bit more than ${this.getGame().getCandies().getCurrent()}`], [`Around ${Math.floor(this.getGame().getCandies().getCurrent() * 0.8)}`, "I don't know", "Way too much", ">o< >o< >o<"], 3), new CallbackCollection(this.nextStep.bind(this), this.reward3.bind(this)), "aTreeThirdQuestionEnigma", "aTreeThirdQuestionWrong");
                break;
            ...
            case 4:
                ...
                this.addEnigma(new EnigmaAnswerStrings(["10", "ten"], ["nine", "9", "32?", "it's a great question", "mmh"]), new CallbackCollection(this.nextStep.bind(this), this.reward4.bind(this)), "aTreeFourthQuestionEnigma", "aTreeFourthQuestionWrong");
                break;
            ...
            case 5:
                ...
                this.addEnigma(new EnigmaAnswerStrings(["wet", "it becomes wet", "it gets wet", "it floats"], ["it disappears", "it flies", "I don't know", "it sinks?"]), new CallbackCollection(this.nextStep.bind(this), this.reward5.bind(this)), "aTreeFifthQuestionEnigma", "aTreeFifthQuestionWrong");
                break;
