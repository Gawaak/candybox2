...
export default function InitText() {
    ...
    Database.addText("br.mapATreeFirstQuestion", "Vou fazer perguntas. Se você acertar, ganhará os doces mais doces! Primeira pergunta: você ama mesmo doces?");
    ...
    Database.addText("br.candyBoxRequestStatusBarUnlockedComment", "Você desbloqueou a barra de status");
    ...
    Database.addText("cz.mapATreeFirstQuestion", "Budu ti dávat hádanky. Pokud odpovíš správně, dostaneš slaďoučkou odměnu! První otázka: Máš opravdu, ale opravdu rád bonbónky?");
    ...
    Database.addText("cz.candyBoxRequestStatusBarUnlockedComment", "Odemknul jsi stavový řádek!");
    ...
    Database.addText("de.mapATreeFirstQuestion", "Ich werde dir Fragen stellen. Wenn du sie korrekt beantwortest, werden die süßesten Süßspeisen deine sein. Die erste : Magst du wirklich Bonbons??");
    ...
    Database.addText("de.candyBoxRequestStatusBarUnlockedComment", "Du hast eine Statusleiste freigeschaltet!");
    ...
    Database.addText("el.mapATreeFirstQuestion", "Θα σου κάνω ερωτήσεις. Αν απαντήεις σωστά στις ερωτήσεις θα ανταμειφθείς με τα πιο γλυκά ζαχαρωτα! Πρώτη : Σου αρέσουν πραγματικά τα ζαχαρωτά;");
    ...
    Database.addText("el.candyBoxRequestStatusBarUnlockedComment", "Ξεκλείδωσες μια μπάρα κατάστασης!");
    ...
    Database.addText("en.mapATreeFirstQuestion", "I will ask you questions. If you answer correctly, the sweetest sweets will be yours! First one : do you really love candies?");
    ...
    Database.addText("en.candyBoxRequestStatusBarUnlockedComment", "You've unlocked a status bar!");
    ...
    Database.addText("es.mapATreeFirstQuestion", "Voy a hacerte preguntas. Si respondes correctamente, te daré los mejores caramelos del mundo. Primera pregunta: ¿de verdad te gustan los caramelos?");
    ...
    Database.addText("es.candyBoxRequestStatusBarUnlockedComment", "¡Has desbloqueado la barra de estado!");
    ...
    Database.addText("fr.mapATreeFirstQuestion", "Je vais te poser des questions. Si tu réponds correctement, les plus douces sucreries seront à toi ! Première question : aimes-tu vraiment les bonbons ?");
    ...
    Database.addText("fr.candyBoxRequestStatusBarUnlockedComment", "Vous avez débloqué une barre d'état !)");
    ...
    Database.addText("hu.mapATreeFirstQuestion", "Kérdéseket fogok feltenni neked. Ha helyesen válaszolsz, megkapod a legédesebb édességeket! Az első : tényleg szereted a cukorkákat?");
    ...
    Database.addText("hu.candyBoxRequestStatusBarUnlockedComment", "Elérhető lett a státusz fül!");
    ...
    Database.addText("id.mapATreeFirstQuestion", "Saya akan memberimu pertanyaan. Jika kamu menjawab dengan benar, penganan termanis akan menjadi milikmu! Pertanyaan pertama : apakah kamu benar-benar menyukai permen?");
    ...
    Database.addText("id.candyBoxRequestStatusBarUnlockedComment", "Kamu mendapatkan status bar!");
    ...
    Database.addText("nl.mapATreeFirstQuestion", "Ik ga je een paar vragen stellen. Als je ze goed beantwoord, zijn de zoetste zoetjes van jou! Eerste vraag: Hou je echt van snoepjes?");
    ...
    Database.addText("nl.candyBoxRequestStatusBarUnlockedComment", "Je hebt een statusbalk ontgrendeld!");
    ...
    Database.addText("pl.mapATreeFirstQuestion", "Będę zadawać ci pytania. Jeśli odpowiesz poprawnie, najsłodsze z cukierków będą twoje! Pierwsze : czy naprawdę kochasz cukierki?");
    ...
    Database.addText("pl.candyBoxRequestStatusBarUnlockedComment", "Odblokowałeś pasek stanu!");
    ...
    Database.addText("ru.mapATreeFirstQuestion", "Я задам тебе несколько вопросов. Если ответишь верно, самые сладкие сладости станут твоими! Первый вопрос: ты на самом деле любишь конфеты?");
    ...
    Database.addText("ru.candyBoxRequestStatusBarUnlockedComment", "Вы разброкировали статус-панель)");
    ...
    Database.addText("se.mapATreeFirstQuestion", "Jag kommer att ställa frågor . Om du svarar rätt , kommer de sötaste godis bli din ! Först en : tror du verkligen älskar godis ?");
    ...
    Database.addText("se.candyBoxRequestStatusBarUnlockedComment", "Du har låst upp en statusrad !");
    ...
    Database.addText("tr.mapATreeFirstQuestion", "Size sorular soracağım. Doğru cevaplarsanız, tatlıların en tatlısı sizin olacak! İlk soru: gerçekten şekerleri seviyor musunuz?");
    ...
    Database.addText("tr.candyBoxRequestStatusBarUnlockedComment", "Durum çubuğunu açtın!");
    ...
    Database.addText("uk.mapATreeFirstQuestion", "Я задаватиму тобі питання. Якщо відповідатимеш правильно, найсолодші солодощі будуть твоїми! Перше запитання : ти справді любиш цукерки?");
    ...
    Database.addText("uk.candyBoxRequestStatusBarUnlockedComment", "Ти розблокував рядок стану!");
    ...
    Database.addText("zh.mapATreeFirstQuestion", "我会问你几个问题。如果你回答正确的话，最甜美的糖果就都是你的了！第一个问题：你真的喜欢糖果吗？");
    ...
    Database.addText("zh.candyBoxRequestStatusBarUnlockedComment", "你解锁了状态栏！");
    ...
    Database.addText("kr.mapATreeFirstQuestion", "내가 너에게 질문을 할게. 정답을 맞히면 가장 달콤한 단 것이 네 것이 될 거야 첫번째: 너는 정말 사탕을 좋아하니?");
    ...
    Database.addText("kr.candyBoxRequestStatusBarUnlockedComment", "상단바 잠금을 해제했어.");
