...
export class Hell extends Quest{
    ...
    private addCamazotz(pos: Pos): void{
        ...
        camazotz.setHealthBar(new QuestEntityHealthBar(camazotz, new Pos(22, 1), new Pos(0, 1)));
        this.addEntity(camazotz);
    }
    
    private addDevil(pos: Pos): void{
        this.devil = new Devil(this, pos, 2, 19);
        this.devil.setHealthBar(new QuestEntityHealthBar(this.devil, new Pos(100, 1), new Pos(0, 1), QuestEntityHealthBarPositionType.FIXED_ON_PAGE, true, true, BarType.HEALTH));
