import {QuestEntityWeaponDelayType} from "./QuestEntityWeaponDelayType";
import {Random} from "./Random";

export class QuestEntityWeaponDelay {
    // The type
    ...
    private minBetweenDelay: number = 0;
    private maxBetweenDelay: number = 0;
    ...
    public setBetweenDelay(minBetweenDelay: number, maxBetweenDelay: number): void {
