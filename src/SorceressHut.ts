...
export class SorceressHut extends Place{
    ...
    private drawBuyingButton(textName: string, callbackCollection : CallbackCollection): void{
        this.renderArea.addAsciiRealButton(Database.getText(textName), 73, 22, "sorceressHutBuyingButton", Database.getTranslatedText(textName), true, -1, undefined, false);
