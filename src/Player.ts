...
export class Player extends QuestEntity {
    // The game
    private game: Game;
    ...
    constructor(game: Game) {
        super()
        this.init(undefined, new Pos(0, 0), new Naming("You", "you"));
    ...
    public getCharacterType(): PlayerCharacterType {
        return <PlayerCharacterType>this.characterType;
    }
    ...
    public getClassicCollisionBoxCollection(): CollisionBoxCollection {
        switch (this.characterType) {
            ...
            default:
                return new CollisionBoxCollection()
        }
    }

    public getQuestEntityWeapon(quest: Quest | null = null): QuestEntityWeapon {
