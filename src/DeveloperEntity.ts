...
import {DeveloperEntityText} from "./DeveloperEntityText";
import {DeveloperMagicBall} from "./DeveloperMagicBall";
...
export class DeveloperEntity extends QuestEntity{
    ...
    private indexOfCurrentText: number = 0;
