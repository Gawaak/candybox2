...
import {QuestEntityWeaponDelay} from "./QuestEntityWeaponDelay";
...
export class QuestEntityWeapon{
    // The quest we are in
    ...
    // Constructor
    constructor(quest: Quest | null, questEntity: QuestEntity, naming: Naming, cbc: CollisionBoxCollection = new CollisionBoxCollection(), damage: number = 0){
        this.quest = quest;
