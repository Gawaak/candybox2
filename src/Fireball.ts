...
import {FireballTargetType} from "./FireballTargetType";

export class Fireball extends QuestEntitySpell {
    // Our size
    private size: Pos;
    ...
    private speed: Pos = new Pos()
    // If FireballTargetType.TARGET_ENTITY or FireballTargetType.TARGET_STICK_ON_ENTITY
    private fireballTargetEntity: QuestEntity | null = null;
    // If FireballTargetType.TARGET_ENTITY
    private specialTargetDamage: number | null = null; // Special damage inflicted to the target
    // If FireballTargetType.TARGET_STICK_ON_ENTITY
    private specialTargetPosition: Pos = new Pos()
    // If FireballTargetType.TARGET_POSITION
    private targetPosition: Pos = new Pos()
    ...
    public setTargetTypeTargetEntity(entity: QuestEntity, specialTargetDamage: number | null = null, speed: Pos = new Pos(1, 1)): void {
