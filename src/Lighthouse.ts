...
// @ts-ignore
import $ from "jquery"
import {LighthousePuzzle} from "./LighthousePuzzle";

Saving.registerBool("lighthousePuzzleDone", false);

export class Lighthouse extends Place {
    // The render area
    ...
    // Show the puzzle?
    private showPuzzle: boolean | null = false;

    // The puzzle
    private puzzle: LighthousePuzzle | null = null;
    ...
    public getPuzzle(): LighthousePuzzle {
        return <LighthousePuzzle>this.puzzle;
    }
    ...
    // Private methods
    private addQuestion(id: string, text: string, translatedText: string | null = null): void {
