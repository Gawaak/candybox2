...
export class MonkeyWizardMagicalPurpleBall extends Fireball{
    // Timer before going down (if null, we should not go down)
    private timer: number | null;
    
    // Constructor
    constructor(quest: Quest, pos: Pos, naming: Naming, color: Color, size: Pos, damage: number, questEntityDamageReason: QuestEntityDamageReason, timer: number | null){
