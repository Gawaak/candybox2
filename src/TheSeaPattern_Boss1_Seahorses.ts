...
export class TheSeaPattern_Boss1_Seahorses extends TheSeaPattern {
    // Variables
    ...
    private seahorseWandering: Seahorse | null = null;
    private seahorseWanderingIsGoingUp: boolean = false;

    // The special seahorse following player
    private seahorseFollowingPlayer: Seahorse | null = null;
    ...
    // Public methods
    public addSeahorse(seahorse: Seahorse | null): Seahorse | null {
        if (seahorse != null) {
