...
export class Treasure extends Place{
    ...
    private update(): void{
        ...
        if(Saving.loadBool("TheCavePattern_TreasureMapFoundTreasure") == false){
            ...
            this.renderArea.addAsciiRealButton(Database.getText("treasureButtonDig"), 49, 14, "treasureButton", Database.getTranslatedText("treasureButtonDig"), true, -1, undefined, false);
