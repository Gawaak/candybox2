...
import {SuperRPGStep} from "./SuperRPGStep";
import {SuperRPGMenu} from "./SuperRPGMenu";
import {SuperRPGFloorStep} from "./SuperRPGFloorStep";
import {SuperRPGMenu_Main} from "./SuperRPGMenu_Main";
import {SuperRPGMenu_Monster} from "./SuperRPGMenu_Monster";
import {SuperRPGMenu_Shop} from "./SuperRPGMenu_Shop";
import {ThirdHouseGame} from "./ThirdHouseGame";
...
export class SuperRPG extends ThirdHouseGame {
    ...
    // The current menu
    private menu: SuperRPGMenu | null = null;

    // Should we exit the game?
    private shouldExitGame: boolean = false;

    // Gameplay variables
    private floor: number = 0; // The current floor
    private floorStep?: SuperRPGFloorStep; // The current floor step (at the shop, the first monster, etc)
    private coins: number = 0; // How many coins do we have?
    private hp: number = 0; // How many hp?
    private maxHp: number = 0; // The max hp
    private weapon: string = ""; // The weapon
    private damage: number = 0; // Damage dealt by the weapon
    private defenseItem: string = ""; // Item used for defense
    private defense: number = 0; // Defense
    ...
    public getFloorStep(): SuperRPGFloorStep | undefined {
