...
import {TheCavePattern_MonkeyWizard} from "./TheCavePattern_MonkeyWizard";
import {Color} from "./Color";
import {ColorType} from "./ColorType";
import {CallbackCollection} from "./CallbackCollection";
import {TheCaveMoveType} from "./TheCaveMoveType";
import {TheCaveAdditionalCharacter} from "./TheCaveAdditionalCharacter";
import {TheCavePattern} from "./TheCavePattern";
import {TheCavePattern_ArrowsToHeartPlug} from "./TheCavePattern_ArrowsToHeartPlug";
import {TheCavePattern_ChocolateBarNow} from "./TheCavePattern_ChocolateBarNow";
import {TheCavePattern_TreasureMap} from "./TheCavePattern_TreasureMap";
import {TheCavePattern_OctopusKing} from "./TheCavePattern_OctopusKing";
...
export class TheCave extends Place {
    ...
    private firstSentence: string | null = null;

    // Pattern currently in use
    private pattern: TheCavePattern | null = null;
    ...
    private createWay(moveType: TheCaveMoveType | null = null): void {
