...
export class Developer extends Quest{
    // The developer
    private developerEntity: DeveloperEntity | null = null;
    ...
    constructor(game: Game){
        ...
        // Resize the quest
        this.resizeQuest(this.getBaseWidth(), 34);
    ...
    private addDeveloperEntity(pos: Pos): void{
        ...
        this.developerEntity.setHealthBar(new QuestEntityHealthBar(this.developerEntity, new Pos(100, 1), new Pos(0, 1), QuestEntityHealthBarPositionType.FIXED_ON_PAGE, true, true, BarType.HEALTH));
