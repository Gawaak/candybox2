...
export class Cfg extends Place{
    ...
    private drawAbout(x: number, y: number): void{
        ...
        // Who...
        this.renderArea.drawString("Ideas, game design & code by aniwey. Mobile version by Gawaak.", x + 4, y + 9);
        ...
        this.renderArea.addHtmlLink(x + 76, y + 16, "https://ezag.ovh/source_code.html", "Learn more.");
        ...
        this.renderArea.addHtmlLink(x + 88, y + 19, "https://ezag.ovh/ascii_art.html", "Learn more.");
        ...
        // Contact
        this.renderArea.drawString("Feel free to contact me at ezag.dev@gmail.com if you have any comments or questions :)", x + 4, y + 24);

        //Version
        this.renderArea.drawString("Game version {{version}}", x, y + 28);
    }
